...
- **Modular entwickeln:** Spiellogik, Rendering und Input in getrennte ES-Module aufteilen (Muster: `games/lumenweber/`). Spiellogik DOM-frei halten. Keine Mega-Dateien.
