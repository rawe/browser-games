...
import { unitSprite, buildingFrame } from './sprites.js';
...
export function createRenderer(canvas, map) {
  ...
  //
  // Das Boss-Porträt hängt bewusst *nicht* mehr neben der Festung: Es war nur
  // dort zu sehen, wo der Boss ohnehin steht – also genau dann nicht, wenn der
  // Blick woanders auf der Karte liegt. Es sitzt jetzt im Boss-HUD des Panels
  // (`main.js`), das die Schlacht über sichtbar bleibt. Auf der Karte tragen den
  // Boss weiterhin Festung, Banner, Lebensbalken und Schutzkuppel.
