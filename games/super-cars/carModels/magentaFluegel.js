...
const STATIONS = [
  ...
  { x: 1.58, pts: [[0.62, 0.98], [0.68, 1.00], [0.74, 1.01], [0.68, 0.78], [0.60, 0]] },
  { x: 1.08, pts: [[0.62, 0.96], [0.68, 0.98], [0.74, 0.99], [0.72, 0.72], [0.64, 0]] },
  ...
  { x: -1.08, pts: [[0.66, 1.09], [0.73, 1.10], [0.84, 1.10], [0.88, 0.68], [0.80, 0]] },
  { x: -1.62, pts: [[0.66, 1.07], [0.73, 1.09], [0.82, 1.10], [0.82, 0.80], [0.76, 0]] },
