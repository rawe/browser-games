...
const STATIONS = [
  ...
  { x: 1.58, pts: [[0.66, 1.00], [0.72, 1.03], [0.78, 1.04], [0.68, 0.80], [0.58, 0]] },
  { x: 1.08, pts: [[0.66, 0.98], [0.72, 1.01], [0.78, 1.02], [0.72, 0.74], [0.62, 0]] },
  ...
  { x: -0.88, pts: [[0.20, 1.02], [0.52, 1.06], [0.78, 1.08], [0.83, 0.65], [0.80, 0]] },
  { x: -1.08, pts: [[0.74, 1.09], [0.82, 1.10], [0.90, 1.10], [0.87, 0.68], [0.80, 0]] },
  { x: -1.62, pts: [[0.74, 1.07], [0.82, 1.09], [0.88, 1.09], [0.82, 0.80], [0.76, 0]] },
  { x: -1.80, pts: [[0.24, 1.03], [0.52, 1.06], [0.76, 1.07], [0.76, 0.82], [0.74, 0]] },
...
function buildPaint() {
  ...
  // Außenspiegel auf den A-Säulen-Basen
  g.box(0.30, 0.96, 0.64, 0.09, 0.05, 0.15, 3);
  g.box(0.30, 0.96, -0.64, 0.09, 0.05, 0.15, 2);
  return g;
}
