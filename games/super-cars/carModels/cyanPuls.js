...
const STATIONS = [
  ...
  { x: 1.58, pts: [[0.66, 1.00], [0.72, 1.03], [0.78, 1.04], [0.66, 0.78], [0.58, 0]] },
  { x: 1.08, pts: [[0.66, 0.98], [0.72, 1.01], [0.78, 1.02], [0.70, 0.72], [0.62, 0]] },
  ...
  { x: -1.08, pts: [[0.74, 1.08], [0.82, 1.09], [0.88, 1.09], [0.82, 0.66], [0.78, 0]] },
  { x: -1.62, pts: [[0.74, 1.06], [0.82, 1.08], [0.86, 1.08], [0.78, 0.76], [0.73, 0]] },
...
function buildPaint() {
  // Ruhigere Facettierung als bei den anderen Typen (kleinerer Jitter).
  ...
  g.box(0.30, 0.96, 0.62, 0.09, 0.05, 0.15, 3);
  g.box(0.30, 0.96, -0.62, 0.09, 0.05, 0.15, 2);
  return g;
}
